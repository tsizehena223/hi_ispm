...
function format_result($resBest)
{
    ...
    $best1_points = $resBest[0][1];
    $best2_points = $resBest[1][1];
    ...
    echo "<a href=\"$lien1\" target=\"blank\">$best1 : $best1_points</a><br>";
    echo "<a href=\"$lien2\" target=\"blank\">$best2 : $best2_points</a>";
}
